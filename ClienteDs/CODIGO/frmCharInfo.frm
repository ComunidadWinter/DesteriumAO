...
20        clsFormulario.Initialize Me
         ...
         ' Me.Picture = LoadPicture(App.path & "\Recursos\VentanaInfoPj.jpg")
...
30        Set cBotonPeticion = New clsGraphicalButton
40        Set cBotonRechazar = New clsGraphicalButton
50        Set cBotonEchar = New clsGraphicalButton
60        Set cBotonAceptar = New clsGraphicalButton
...
20        Call WriteGuildAcceptNewMember(Nombre)
30        Unload frmGuildLeader
40        Call WriteRequestGuildLeaderInfo
50        Unload Me
End Sub
...
10    Call Audio.PlayWave(SND_CLICK)
20        Call WriteGuildKickMember(Nombre)
30        Unload frmGuildLeader
40        Call WriteRequestGuildLeaderInfo
50        Unload Me
End Sub
...
10    Call Audio.PlayWave(SND_CLICK)
20        Call WriteGuildRequestJoinerInfo(Nombre)
End Sub

Private Sub imgRechazar_Click()
10    Call Audio.PlayWave(SND_CLICK)
20        frmCommet.t = RECHAZOPJ
30        frmCommet.Nombre = Nombre.Caption
40        frmCommet.Show vbModeless, frmCharInfo
End Sub

Private Sub txtMiembro_MouseMove(Button As Integer, Shift As Integer, X As _
    Single, Y As Single)
10        LastPressed.ToggleToNormal
End Sub
