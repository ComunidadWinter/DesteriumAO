...
Public Sub ScreenCapture(Optional ByVal Autofragshooter As Boolean = False, _
                         Optional ByVal iPic As Boolean = False)
    ...
    'frmScreenshots.Picture1.Width = 15420
    'frmScreenshots.Picture1.Height = 11575
    ...
    If Not iPic Then AddtoRichTextBox frmMain.RecTxt, "Screen Capturada!", 200, 200, 200, False, False, True
    Exit Sub
