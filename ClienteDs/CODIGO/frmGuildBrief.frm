...
10        frmCommet.Nombre = Nombre.Caption
20        frmCommet.t = Tipo.ALIANZA
30        Call frmCommet.Show(vbModal, frmGuildBrief)
End Sub

Private Sub ImgOfrecerpaz_Click()
10        frmCommet.Nombre = Nombre.Caption
20        frmCommet.t = Tipo.PAZ
30        Call frmCommet.Show(vbModal, frmGuildBrief)
End Sub
...
10        Call WriteGuildDeclareWar(Nombre.Caption)
20        Unload Me
End Sub
...
10        Call frmGuildSol.RecieveSolicitud(Nombre.Caption)
20        Call frmGuildSol.Show(vbModal, frmGuildBrief)
End Sub
