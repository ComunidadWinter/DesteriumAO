...
10        Distancia = Abs(wp1.X - wp2.X) + Abs(wp1.Y - wp2.Y) + (Abs(wp1.map - wp2.map) * 100)
End Function
...
10    Distance = Sqr(((Y1 - Y2) ^ 2 + (X1 - X2) ^ 2))
...
Public Function RandomNumber(ByVal LowerBound As Long, ByVal UpperBound As Long) As Long
      ...
      '**************************************************************
10        RandomNumber = Fix(Rnd * (UpperBound - LowerBound + 1)) + LowerBound
End Function
