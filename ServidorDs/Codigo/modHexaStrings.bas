...
10        If Len(MD5) And &H1 Then MD5 = "0" & MD5
          
20        For i = 1 To Len(MD5) \ 2
30            L = mid$(MD5, (2 * i) - 1, 2)
40            hexMd52Asc = hexMd52Asc & Chr$(hexHex2Dec(L))
50        Next i
End Function
...
10        For i = 1 To Len(Text)
20            L = mid$(Text, i, 1)
30            txtOffset = txtOffset & Chr$((Asc(L) + off) And &HFF)
40        Next i
End Function
