    ...
    If Left$(Comando, 1) = "/" Then
        ...
        Case "/CAER"
            ...
            Case "/ONLINE"
                ...
                Else
                    Call ShowConsoleMsg("Comando desconocido.")
                End If
...
Case "/DEPOSITARTODO"
  ...
  Call WriteReset
            ...
            Case "/FUNDARCLAN"
                ...
                Else
                    Call ShowConsoleMsg("Para fundar un clan tenés que ser nivel 45, tener 90 skills en liderazgo y haber recolectado los 3 amuletos de líder.")
                End If
...
End If
            ...
            Case "/EVENTOS"
                If esGM(UserCharIndex) Then
                    Call frmPanelTorneo.Show(vbModeless, frmMain)
                End If
            ...
            Case "/LARRY"
                If notNullArguments Then
                    ...
                    If UBound(tmpArr) = 1 Then
                        If ValidNumber(tmpArr(1), eNumber_Types.ent_Byte) Then
                            Call WriteLarryMataNiños(tmpArr(0), tmpArr(1))
                        Else
                            'Faltan o sobran los parametros con el formato propio
                            Call ShowConsoleMsg("Formato incorrecto. Utilice /LARRY NICK@TIPO.")
                        End If
                    Else
                        'Faltan o sobran los parametros con el formato propio
                        With FontTypes(FontTypeNames.FONTTYPE_INFO)
