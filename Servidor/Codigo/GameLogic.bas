...
End If
Else
Call WriteConsoleMsg(Userindex, "Sólo los usuarios PREMIUM pueden ingresar a este mapa.", FontTypeNames.FONTTYPE_CONSE)
Call ClosestStablePos(UserList(Userindex).Pos, nPos)
...
End If
Else
Call WriteConsoleMsg(Userindex, "Sólo los usuarios Bronce, Plata y Oro pueden ingresar a este mapa.", FontTypeNames.FONTTYPE_CONSE)
Call ClosestStablePos(UserList(Userindex).Pos, nPos)
