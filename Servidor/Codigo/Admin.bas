...
'MERCHANTABILITY or FITNESS FOR A PARTICULAfR PURPOSE.  See the
...
On Error Resume Next
    ...
    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Iniciando WorldSave y limpieza del mundo.", FontTypeNames.FONTTYPE_SERVER))
    ...
    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> ¡No te pierdas las increíbles promociones 2x1 de este mes! Entrá a http://www.Desterium-ao.jimdosite.com/donaciones ", FontTypeNames.FONTTYPE_GM))
