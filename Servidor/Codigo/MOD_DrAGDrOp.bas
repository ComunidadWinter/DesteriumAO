...
'Seria raro que llegue para acá
    ...
    If Amount > 0 Then
        ...
        End If
    Else
Call LogAntiCheat(UserList(Userindex).Name & " intentó dupear en Drag To Pos")
Call SendData(SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg(UserList(Userindex).Name & " intentó dupear.", FontTypeNames.FONTTYPE_INFO))
