...
'***************************************************
    ...
    End If
     ...
     If (UserList(UserIndex).Stats.Gld < 25000000) _
 ...
 Or TieneObjetos(887, 1, UserIndex) = False _
  Or TieneObjetos(888, 1, UserIndex) = False _
    Or (UserList(UserIndex).Stats.UserSkills(eSkill.Liderazgo) < 100) Then
        ...
        refError = "Para fundar clan necesitas encontrar los tres amuletos de Lider, disponer de 25.000.000 monedas de oro en tu billetera y tener 100 puntos en liderazgo. "
        Exit Function
    End If
...
'***************************************************
    ...
    If Not FileExist(CharPath & Personaje & ".CHR", vbArchive) Then
        Call guilds(GI).RetirarAspirante(Personaje, NroAsp)
    End If
