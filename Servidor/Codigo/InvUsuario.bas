...
If ObjData(MiObj.objindex).OBJType = eOBJType.otAzul Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Azul. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                 
If ObjData(MiObj.objindex).OBJType = eOBJType.otNaranja Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Naranja. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
If ObjData(MiObj.objindex).OBJType = eOBJType.otCeleste Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Celeste. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                 
If ObjData(MiObj.objindex).OBJType = eOBJType.otLila Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Lila. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                 
If ObjData(MiObj.objindex).OBJType = eOBJType.otroja Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Roja. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                 
If ObjData(MiObj.objindex).OBJType = eOBJType.otverde Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Verde. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                 
If ObjData(MiObj.objindex).OBJType = eOBJType.otvioleta Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Violeta. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
                  
If ObjData(MiObj.objindex).OBJType = eOBJType.otLunar Then
                Call SendData(ToAll, 0, PrepareMessageConsoleMsg(UserList(UserIndex).Name & " ha agarrado una Gema Lunar. Se encuentra en el mapa " & UserList(UserIndex).Pos.map, FontTypeNames.FONTTYPE_GUILD))
                  End If
            ...
            Case eOBJType.otInstrumentos
              ...
              Case eOBJType.otMonturas
                ...
                If .flags.SlotEvent > 0 Then
                    WriteConsoleMsg UserIndex, "¡¡No puedes traer tu montura aquí!!", FontTypeNames.FONTTYPE_INFO
                    Exit Sub
                End If
