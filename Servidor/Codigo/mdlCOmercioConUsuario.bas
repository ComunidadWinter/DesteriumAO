...
'***************************************************
    ...
    If UserList(Origen).ComUsu.DestUsu = Destino And _
       ...
       If UserList(Origen).flags.Comerciando Or UserList(Destino).flags.Comerciando Then
            Call WriteConsoleMsg(Origen, "No puedes comerciar en este momento", FontTypeNames.FONTTYPE_GUILD)
            Call WriteConsoleMsg(Destino, "No puedes comerciar en este momento", FontTypeNames.FONTTYPE_GUILD)
            Exit Sub
        End If
        
        If UserList(Origen).flags.Montando Or UserList(Destino).flags.Montando Then
            Call WriteConsoleMsg(Origen, "Proceso cancelado por uso de monturas o otro tipo de items.", FontTypeNames.FONTTYPE_INFO)
            Call WriteConsoleMsg(Destino, "Proceso cancelado por uso de monturas o otro tipo de items.", FontTypeNames.FONTTYPE_INFO)
            Exit Sub
        End If
    ...
    Else
        ...
        Call WriteConsoleMsg(Destino, UserList(Origen).Name & " desea comerciar. Si deseas aceptar, escribe /COMERCIAR.", FontTypeNames.FONTTYPE_GUILD)
