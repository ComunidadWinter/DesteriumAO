...
End If
    ...
    If (Torneo_Rondas = 1) Then
        ...
        'Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("1vs1> " & UserList(UserIndex).Name & " pierde el combate!", FontTypeNames.FONTTYPE_GUILD))
        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("1vs1> El ganador del torneo es " & UserList(Torneo_Luchadores(LI1)).Name & " que se lleva un total de 1 punto de torneo y 500.000 monedas de oro. ¡FELICIDADES!", FontTypeNames.FONTTYPE_CONSEJOVesA))
        ...
        UserList(Torneo_Luchadores(LI1)).Stats.GLD = UserList(Torneo_Luchadores(LI1)).Stats.GLD + 500000
