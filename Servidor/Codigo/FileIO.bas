...
.Monturasskill = val(Leer.GetValue("OBJ" & Object, "MonturasSkill"))
ObjData(Object).QuitaEnergia = val(Leer.GetValue("OBJ" & Object, "Energia"))
            .Quince = val(Leer.GetValue("OBJ" & Object, "Quince"))
            .Treinta = val(Leer.GetValue("OBJ" & Object, "Treinta"))
            .HM = val(Leer.GetValue("OBJ" & Object, "HM"))
            .UM = val(Leer.GetValue("OBJ" & Object, "UM"))
            .MM = val(Leer.GetValue("OBJ" & Object, "MM"))
            .VIP = val(Leer.GetValue("OBJ" & Object, "VIP"))
            .VIPB = val(Leer.GetValue("OBJ" & Object, "VIPB"))
            .VIPP = val(Leer.GetValue("OBJ" & Object, "VIPP"))
            ...
            Select Case .OBJType
                ...
                Case eOBJType.otMonturas
                    .Velocidad = val(Leer.GetValue("OBJ" & Object, "Velocidad"))
                    .MinSkill = val(Leer.GetValue("OBJ" & Object, "MinSkill"))
                    .MaxHIT = val(Leer.GetValue("OBJ" & Object, "MaxHIT"))
                    .MinHIT = val(Leer.GetValue("OBJ" & Object, "MinHIT"))
            ...
            .Canjes = val(Leer.GetValue("OBJ" & Object, "Canjes"))
            
            ObjData(Object).Premium = val(Leer.GetValue("OBJ" & Object, "PREMIUM"))
            .copaS = val(Leer.GetValue("OBJ" & Object, "DsP"))
            .Eldhir = val(Leer.GetValue("OBJ" & Object, "Eldhires"))
...
Errhandler:
    MsgBox "error cargando objetos " & Err.Number & ": " & Err.Description & " En el Objeto: " & Object
...
With UserList(UserIndex)
    ...
    For LoopC = 0 To MAX_LOGROS
        TmpStr = UserFile.GetValue("STATS", "LOGROS")
        .Logros(LoopC) = val(ReadField(LoopC + 1, TmpStr, Asc("-")))
    Next LoopC
    ...
    With .Stats
        ...
        .puntos = CInt(UserFile.GetValue("STATS", "Puntos")) 'De esta forma se leen valores mayores a 255 y por lo tanto permite logear el personaje.
        
        
        .UsuariosMatados = CLng(UserFile.GetValue("MUERTES", "UserMuertes"))
        .NPCsMuertos = CInt(UserFile.GetValue("MUERTES", "NpcsMuertes"))
        
        .RetosGanados = CInt(UserFile.GetValue("RETOS", "RetosGanados"))
        .RetosPerdidos = CInt(UserFile.GetValue("RETOS", "RetosPerdidos"))
        .OroGanado = CLng(UserFile.GetValue("RETOS", "OroGanado"))
        .OroPerdido = CLng(UserFile.GetValue("RETOS", "OroPerdido"))
        
        .TorneosGanados = CInt(UserFile.GetValue("TORNEOS", "TorneosGanados"))
...
'*************************************************
    ...
    With UserList(UserIndex)
        ...
        With .Mercado
            .InList = CInt(UserFile.GetValue("MERCADO", "InList"))
            .Change = CBool(UserFile.GetValue("MERCADO", "Change"))
            .Dsp = CLng(UserFile.GetValue("MERCADO", "DSP"))
            .dstName = UserFile.GetValue("MERCADO", "dstName")
            .Gld = CLng(UserFile.GetValue("MERCADO", "GLD"))
            
            
            For i = 1 To MAX_OFFER
                .lstOffer(i) = UserFile.GetValue("MERCADO", "Offer" & i)
                .lstOfferSent(i) = UserFile.GetValue("MERCADO", "OfferSent" & i)
            Next i
        ...
        With .flags
            ...
            .BonosHP = CByte(UserFile.GetValue("FLAGS", "BonosHP"))
            ...
            .DiosTerrenal = CByte(UserFile.GetValue("FLAGS", "DiosTerrenal"))
...
End If
        ...
        .Invent.MonturaSlot = CByte(UserFile.GetValue("Inventory", "MonturaSlot"))
...
On Error GoTo errh
    ...
    With MapInfo(map)
        ...
        If .levelmax < 48 Then .levelmax = 48
...
With UserList(UserIndex)
    ...
    Call Manager.ChangeValue("FLAGS", "BonosHP", CStr(.flags.BonosHP))
    ...
    Call Manager.ChangeValue("FLAGS", "DiosTerrenal", CStr(.flags.DiosTerrenal))
    'Matrix
    ...
    With .Mercado
        Call Manager.ChangeValue("MERCADO", "InList", CStr(.InList))
        Call Manager.ChangeValue("MERCADO", "Change", CStr(.Change))
        Call Manager.ChangeValue("MERCADO", "DSP", CStr(.Dsp))
        Call Manager.ChangeValue("MERCADO", "dstName", CStr(.dstName))
        Call Manager.ChangeValue("MERCADO", "GLD", CStr(.Gld))
            
            
        For LoopC = 1 To MAX_OFFER
            Call Manager.ChangeValue("MERCADO", "Offer" & LoopC, CStr(.lstOffer(LoopC)))
            Call Manager.ChangeValue("MERCADO", "OfferSent" & LoopC, CStr(.lstOfferSent(LoopC)))
        Next LoopC
...
#End If
    ...
    Call Manager.ChangeValue("STATS", "LOGROS", CStr(TmpStr))
    
    Call Manager.ChangeValue("STATS", "GLD", CStr(.Stats.Gld))
    Call Manager.ChangeValue("STATS", "BANCO", CStr(.Stats.Banco))
    
    Call Manager.ChangeValue("STATS", "PUNTOS", CStr(.Stats.puntos))
    ...
    Call Manager.ChangeValue("RETOS", "RetosGanados", CStr(.Stats.RetosGanados))
    Call Manager.ChangeValue("RETOS", "RetosPerdidos", CStr(.Stats.RetosPerdidos))
    Call Manager.ChangeValue("RETOS", "OroGanado", CStr(.Stats.OroGanado))
    Call Manager.ChangeValue("RETOS", "OroPerdido", CStr(.Stats.OroPerdido))
    Call Manager.ChangeValue("TORNEOS", "TorneosGanados", CStr(.Stats.TorneosGanados))
    '[KEVIN]----------------------------------------------------------------------------
    '*******************************************************************************************
...
'***************************************************
    ...
    With Npclist(NpcIndex)
        ...
        .flags.AguaValida = val(GetVar(npcfile, "NPC" & NpcNumber, "AguaValida"))
        .flags.TierraInvalida = val(GetVar(npcfile, "NPC" & NpcNumber, "TierraInValida"))
        .flags.Faccion = val(GetVar(npcfile, "NPC" & NpcNumber, "Faccion"))
        .flags.AtacaDoble = val(GetVar(npcfile, "NPC" & NpcNumber, "AtacaDoble"))
        ...
        .GiveEXP = val(GetVar(npcfile, "NPC" & NpcNumber, "GiveEXP")) * Expc
