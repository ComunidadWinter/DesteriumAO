...
End Sub
Public Sub LogCRC(texto As String)
'***************************************************
'Author: Unknown
'Last Modification: -
'
...
On Error GoTo Errhandler
    ...
    nfile = FreeFile ' obtenemos un canal
    'Guardamos todo en el mismo lugar. Pablo (ToxicWaste) 18/05/07
    Open App.Path & "\logs\CRC.log" For Append Shared As #nfile
    Print #nfile, Date & " " & time & " " & texto
    Close #nfile
...
If .Counters.TimeFight > 0 Then
            ...
            If .Counters.TimeCastleMode > 0 Then
                ...
                If .Counters.TimeCastleMode <= 0 Then
                    EventosDS.CastleMode_UserRevive i
    ...
    Call Mod_2vs2.user_retoLoop(CInt(i))
            ...
            If UserList(i).Counters.Saliendo Then
                ...
                If UserList(i).Counters.Salir <= 0 Then
                   Call WriteConsoleMsg(i, "Gracias por jugar Desterium AO", FontTypeNames.FONTTYPE_INFO)
...
Public Sub CheckLogros(ByVal UserIndex As Integer)
    With UserList(UserIndex)
        ...
        If .Logros(0) = 0 Then
            ...
            WriteConsoleMsg UserIndex, "Has recibido el logro N°1 como agradecimiento por jugar DesteriumAO. Has recibido 10.000 monedas de oro como recompensa.", FontTypeNames.FONTTYPE_GUILD
        ...
        ' Nivel 47
        If .Logros(1) = 0 And .Stats.ELV = STAT_MAXELV Then
            .Logros(1) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°2. ¡Felicitaciones has alcanzado el nivel máximo! Recibiste 1.000.000 monedas de oro.", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 1000000
            WriteUpdateGold UserIndex
        End If
        
        ' Fundador de clan
        If .Logros(2) = 0 And HasFound(.Name) Then
            .Logros(2) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°3 debido a que has fundado un clan. ", FontTypeNames.FONTTYPE_GUILD

        End If
    
        ' Usuario Oro
        If .Logros(3) = 0 And .flags.Oro > 0 Then
            .Logros(3) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°4 debido a que eres usuario ORO. ", FontTypeNames.FONTTYPE_GUILD
        End If
        
        ' Usuario premium
        If .Logros(4) = 0 And .flags.Premium > 0 Then
            .Logros(4) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°5 debido a que eres usuario PREMIUM. ", FontTypeNames.FONTTYPE_GUILD
        End If
        
        ' Usuarios matados 100
        If .Logros(5) = 0 And .Stats.UsuariosMatados >= 100 Then
            .Logros(5) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°6 debido a que has alcanzado los 100 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 250000
            WriteUpdateGold UserIndex
        End If
        
        ' Usuarios matados 200
        If .Logros(6) = 0 And .Stats.UsuariosMatados >= 200 Then
            .Logros(6) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°7 debido a que has alcanzado los 200 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
        ...
        If .Logros(7) = 0 And .Stats.UsuariosMatados >= 400 Then
            .Logros(7) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°8 debido a que has alcanzado los 400 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 750000
            WriteUpdateGold UserIndex
        End If
        
        ' Usuarios matados 800
        If .Logros(8) = 0 And .Stats.UsuariosMatados >= 800 Then
            .Logros(8) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°9 debido a que has alcanzado los 800 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 1000000
            WriteUpdateGold UserIndex
        End If
        
        ' Usuarios matados 1600
        If .Logros(9) = 0 And .Stats.UsuariosMatados >= 1600 Then
            .Logros(9) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°10 debido a que has alcanzado los 1600 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 2000000
            WriteUpdateGold UserIndex
        End If
        
        ' Usuarios matados 5000
        If .Logros(10) = 0 And .Stats.UsuariosMatados >= 5000 Then
            .Logros(10) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°11 debido a que has alcanzado los 5000 usuarios matados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 4000000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(11) = 0 And .Stats.RetosGanados >= 5 Then
            .Logros(11) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°12 debido a que has alcanzado los 5 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 150000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(12) = 0 And .Stats.RetosGanados >= 10 Then
            .Logros(12) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°13 debido a que has alcanzado los 10 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 300000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(13) = 0 And .Stats.RetosGanados >= 50 Then
            .Logros(13) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°14 debido a que has alcanzado los 50 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 500000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(14) = 0 And .Stats.RetosGanados >= 100 Then
            .Logros(14) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°15 debido a que has alcanzado los 100 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 600000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(15) = 0 And .Stats.RetosGanados >= 250 Then
            .Logros(15) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°16 debido a que has alcanzado los 250 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 1000000
            WriteUpdateGold UserIndex
        End If
        
        ' Retos ganados
        If .Logros(16) = 0 And .Stats.RetosGanados >= 1000 Then
            .Logros(16) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°17 debido a que has alcanzado los 1000 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 3500000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(17) = 0 And .Stats.TorneosGanados >= 5 Then
            .Logros(17) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°18 debido a que has alcanzado los 5 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 300000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(18) = 0 And .Stats.TorneosGanados >= 10 Then
            .Logros(18) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°19 debido a que has alcanzado los 10 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 500000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(19) = 0 And .Stats.TorneosGanados >= 20 Then
            .Logros(19) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°20 debido a que has alcanzado los 20 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 600000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(20) = 0 And .Stats.TorneosGanados >= 30 Then
            .Logros(20) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°21 debido a que has alcanzado los 30 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 700000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(21) = 0 And .Stats.TorneosGanados >= 40 Then
            .Logros(21) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°22 debido a que has alcanzado los 40 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 800000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(22) = 0 And .Stats.TorneosGanados >= 50 Then
            .Logros(22) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°23 debido a que has alcanzado los 50 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 900000
            WriteUpdateGold UserIndex
        End If
        
        If .Logros(23) = 0 And .Stats.TorneosGanados >= 100 Then
            .Logros(23) = 1
            
            WriteConsoleMsg UserIndex, "Has recibido el logro N°24 debido a que has alcanzado los 100 retos ganados. ", FontTypeNames.FONTTYPE_GUILD
            .Stats.Gld = .Stats.Gld + 1000000
            WriteUpdateGold UserIndex
        End If
    End With
