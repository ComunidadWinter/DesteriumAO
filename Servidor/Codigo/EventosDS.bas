            ...
            If .Enabled Then
                If .TimeInit > 0 Then
                    ...
                    Select Case .TimeInit
                        Case 0
                            SendData SendTarget.ToAll, 0, PrepareMessageConsoleMsg(strModality(LoopC, .Modality) & "> Las inscripciones están abiertas", FontTypeNames.FONTTYPE_CONTEO)
                        Case 60
                ...
                If .TimeCancel > 0 Then
                    ...
                    If .TimeCancel <= 0 Then
                        ...
                        EventosDS.CloseEvent LoopC, "Evento " & strModality(LoopC, .Modality) & " cancelado."
                    End If
                End If
                ...
                If .TimeCount > 0 Then
                    ...
                    For LoopY = LBound(.Users()) To UBound(.Users())
                        If .Users(LoopY).Id > 0 Then
                            ...
                            Else
                                WriteConsoleMsg .Users(LoopY).Id, "CONTEO> " & .TimeCount, FontTypeNames.FONTTYPE_CONTEOS
                            End If
                        End If
                    Next LoopY
                End If
