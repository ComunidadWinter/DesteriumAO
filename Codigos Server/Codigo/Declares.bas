...
' @ Utilizado para las ofertas que recibimos
Public Type tMercadoUser
    OfertasRecibidas As String
    OfertasHechas As String
End Type

Public ArbT As Integer
Public NickPjIngreso As String ' Party
Public EnvioPar As Integer
Public EnvioNewMember As Integer
...
Public Const MaxOro As Long = 50000000
...
Public Const EXP_ACIERTO_SKILL As Byte = 150
Public Const EXP_FALLO_SKILL As Byte = 100
...
indexmercado As Integer
    Depositor As String ' @ Mercado AO
Infectado As Byte
Angel As Byte
Demonio As Byte
 BonosHP As Byte
...
MapY As Integer
    ...
    RandomKey As Integer ' Seguridad peruana.
...
Redundance As Byte
    ...
    flags As UserFlags
    AskTh As Integer
    Ofertas(1 To 10) As tMercadoUser
