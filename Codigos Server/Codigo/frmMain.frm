...
Case 60
For i = 1 To LastUser
If Not MD5ok(ELMD5) Then
    ' WriteErrorMsg i, "Tu cliente no pasó la prueba de verificación, por favor descarguelo de nuevo."
     FlushBuffer i
     CloseSocket i
     Exit Sub
     Else
  ' Call WriteConsoleMsg(i, "Verificación> Tu cliente pasó la prueba de verificación, gracias por jugar Fusion Argentum.", FontTypeNames.FONTTYPE_VENENO)
    End If
Next i
End Select
End Sub
