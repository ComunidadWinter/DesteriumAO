...
End Function
Function EsUsuario(ByRef name As String) As Boolean
'***************************************************
'Author: Unknown
'Last Modification: 27/03/2011
'27/03/2011 - ZaMa: Utilizo la clase para saber los datos.
'***************************************************
    EsUsuario = PlayerType.User
End Function
...
'***************************************************
    ...
    ElseIf EsUsuario(UserName) Then
...
'*************************************************
    ...
    With UserList(UserIndex)
        ...
        ' @ Cargamos las ofertas del mercado.
        For i = 1 To 10
            .Ofertas(i).OfertasHechas = UserFile.GetValue("MERCADO", "OfertaHecha" & i)
            .Ofertas(i).OfertasRecibidas = UserFile.GetValue("MERCADO", "OfertaRecibida" & i)
        Next i
...
With UserList(UserIndex)
    ...
    For LoopC = 1 To 10
        Call WriteVar(UserFile, "MERCADO", "OfertaRecibida" & LoopC, CStr(.Ofertas(LoopC).OfertasRecibidas))
        Call WriteVar(UserFile, "MERCADO", "OfertaHecha" & LoopC, CStr(.Ofertas(LoopC).OfertasHechas))
    Next LoopC
