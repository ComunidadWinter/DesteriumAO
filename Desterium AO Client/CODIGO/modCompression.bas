...
Public Const GRH_RESOURCE_FILE As String = "Graficos.DS"
Public Const GRH_PATCH_FILE As String = "Graficos.PATCH"
Public Const MAPS_SOURCE_FILE_EXT As String = ".map"
Public Const MAPS_RESOURCE_FILE As String = "Maps.DS"
...
Public Function ArrayToPicture(inArray() As Byte, offset As Long, Size As Long) As IPicture
    ...
    End If
End Function
Public Function Get_Bitmapp(ByRef ResourcePath As String, ByRef FileName As String, ByRef bmpInfo As BITMAPINFO, ByRef data() As Byte) As Boolean
'*****************************************************************
'Author: Nicolas Matias Gonzalez (NIGO)
'Last Modify Date: 11/30/2007
'Retrieves bitmap file data
'*****************************************************************
    ...
    If Get_InfoHeader(ResourcePath, FileName, InfoHead, 0) Then
        If Extract_File(ResourcePath, InfoHead, data, 0) Then Get_Bitmapp = True
    Else
        Call MsgBox("No se encontro el recurso " & FileName)
    End If
End Function
